// ============================================================================
// ZANGENSCHLOSSER-APP: SHELL / GLOBAL UI CONTROLLER (v1.12.1)
// ============================================================================
window.AppShell = (() => {
  ...
  function openSubModal(type) {
    ...
    if (type.startsWith('logbook-')) {
      ...
      const logs = (window.allLogbooks && window.allLogbooks[key]) ? window.allLogbooks[key] : [
        { version: "v1.12.1", date: "19.09.2026, 17:50 (MEZ)", text: "Aktualisierung auf Version v1.12.1 durchgeführt.", border: "border-indigo-500" }
      ];
      ...
      contentEl.innerHTML = `
        <div class="space-y-3 text-slate-700 text-sm">
          ...
          <p class="text-xs text-slate-500">Version: v1.12.1</p>
        </div>
      `;
    }
