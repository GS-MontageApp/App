window.allLogbooks = {
  master: [
    { version: "v1.10.33", date: "13.09.2026, 13:00 (MEZ)", text: "Tabellendaten (DIN/EO-Form) in js/eo-data.js ausgelagert und dynamischer DOM-Renderer implementiert.", border: "border-indigo-500" },
  ...
  tabellen: [
    { version: "v1.10.33", date: "13.09.2026, 13:00 (MEZ)", text: "Datengetriebenes Rendering via js/eo-data.js aktiviert.", border: "border-indigo-500" },
