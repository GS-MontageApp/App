...
window.allLogbooks = {
  master: [
    { version: "v1.10.36", date: "13.09.2026, 13:00 (MEZ)", text: "LocalStorage-Persistenz für markierte Tabellenzeilen in allen Sub-Tabs (DIN, L, S) aktiviert.", border: "border-indigo-500" },
  ...
  tabellen: [
    { version: "v1.10.36", date: "13.09.2026, 13:00 (MEZ)", text: "Persistenz der markierten Tabellenzeilen via LocalStorage mit Signatur-Abgleich für alle Sub-Tabs (DIN, L, S) aktiv.", border: "border-indigo-500" },
